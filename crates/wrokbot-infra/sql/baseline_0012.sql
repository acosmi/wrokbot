-- crates/wrokbot-infra/sql/baseline_0012.sql
--
...
--
-- 终态事实（由 crates/wrokbot-infra/sql/schema_facts.sql 在参照库上实跑得出）：
...
--
-- 这份文件由 wrokbot-infra::db::baseline::BASELINE_0012_SQL 以 include_str! 嵌入二进制；
