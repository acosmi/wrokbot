...
use wrokbot_contracts::auth::{AuthContext, AuthContextBuilder, Role};
...
use wrokbot_domain::policy::context::{ActorRef, BotRef, PageRef, PolicyContext, ToolRef};
use wrokbot_domain::policy::{ActionPolicy, CompiledActionPolicy, PolicyMode, evaluate};
use wrokbot_domain::tool::approval::ApprovalTarget;
...
use wrokbot_domain::tool::pipeline::ApprovalOutcome;
use serde_json::json;
...
impl ToolControlPlane for FakeControl {
    ...
    async fn resolve_scope(
        ...
        Ok(ResolvedToolScope {
            ...
            computer_generation: wrokbot_contracts::ids::ComputerGeneration::new(1),
