...
use wrokbot_application::PolicyAdministration;
...
use wrokbot_infra::policy::{ACTION_POLICY_TOPIC, PolicyListener, PolicyOrigin, PolicyStore};
...
where
    F: FnOnce(deadpool_postgres::Pool, wrokbot_infra::db::pool::DatabaseConfig) -> Fut,
