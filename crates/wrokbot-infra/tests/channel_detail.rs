...
use wrokbot_contracts::command::{AppEvent, BeginThreadRun, ThreadRunAnchor};
use wrokbot_contracts::ids::{ActorId, BotId, ChannelId, DeploymentId, RunId, TenantId};
        ...
        let result = async {
            ...
            if !directory
                .thread_known(
                    ...
                    &ActorId::new("actor-a"),
                    &wrokbot_contracts::ids::ThreadId::new("thread-shared"),
                )
                .await
                .map_err(|error| error.to_string())?
            {
            ...
            directory
                .begin_thread_run(BeginThreadRunRequest {
                    ...
                    command: BeginThreadRun {
                        ...
                        thread_id: wrokbot_contracts::ids::ThreadId::new("thread-shared"),
            ...
            let shared_request = ThreadHistoryRequest {
                ...
                thread: wrokbot_contracts::ids::ThreadId::new("thread-shared"),
            };
