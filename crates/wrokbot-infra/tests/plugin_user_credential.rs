...
use wrokbot_application::PeopleAdministration;
...
use wrokbot_infra::store::plugin_user_credential::{
            ...
            client
                .batch_execute(
                    "INSERT INTO public.users(id,email,name,email_verified,auth_generation) VALUES
                     ('credential-admin','admin@wrokbot.test','Admin',true,0),
                     ('credential-asker','asker@wrokbot.test','Asker',true,0),
                     ('credential-other','other@wrokbot.test','Other',true,0);
