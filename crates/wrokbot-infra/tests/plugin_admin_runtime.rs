...
use wrokbot_application::{McpConnectionAdministration, McpConnectionError};
...
use wrokbot_contracts::mcp::{PluginGrantKind, PluginGrantMutation, PluginSkillMutation};
use wrokbot_domain::audit::hash::{CanonicalWriter, Sha256Digest};
            ...
            require(
                admin_page.servers.len() == 1
                    && admin_page.servers[0].authentication
                        == wrokbot_contracts::mcp::McpAdminAuthentication::None
