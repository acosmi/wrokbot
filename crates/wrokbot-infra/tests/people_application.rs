...
use wrokbot_application::{PeopleAdministration, PeoplePageRequest, PeoplePortError};
...
INSERT INTO public.users(id,email,name) VALUES
  ...
  ('recent-000','recent-000@wrokbot.test','Person 0'),
  ('recent-001','recent-001@wrokbot.test','Person 1'),
  ('recent-002','recent-002@wrokbot.test','Person 2'),
  ('recent-003','recent-003@wrokbot.test','Person 3'),
  ('recent-004','recent-004@wrokbot.test','Person 4'),
  ('recent-005','recent-005@wrokbot.test','Person 5'),
  ('literal','literal@wrokbot.test','Ninety _ Percent'),
  ('target-099','target-099@wrokbot.test','Grace Hopper'),
  ('never','never@wrokbot.test','Never');
