...
use wrokbot_domain::thread::MessageId;
...
async fn insert_memory(
    ...
    .map_err(|error| match error {
        wrokbot_domain::memory::MemoryError::ExpiryInvalid => {
            MemoryAdministrationError::InvalidInput {
                field: "expires_at",
            }
        }
        wrokbot_domain::memory::MemoryError::SourceRequired => {
            MemoryAdministrationError::InvalidInput { field: "source" }
        }
        wrokbot_domain::memory::MemoryError::ContentEmpty => {
            MemoryAdministrationError::InvalidInput { field: "content" }
        }
        wrokbot_domain::memory::MemoryError::TagEmpty => {
            MemoryAdministrationError::InvalidInput { field: "tags" }
        }
        wrokbot_domain::memory::MemoryError::NotActive => MemoryAdministrationError::Conflict,
    })?;
