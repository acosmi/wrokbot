...
use wrokbot_contracts::agent::AgentVisibility;
...
use wrokbot_domain::agent::profile_policy::{AgentActor, AgentProfileFacts, can_run_agent};
...
fn decode_pending_human_decision(
    ...
    Ok(PendingComponentHumanDecision {
        decision_id,
        run_id: wrokbot_contracts::ids::RunId::new(run_id),
        provider_call_id,
