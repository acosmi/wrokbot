    ...
    fn request_shape_preserves_system_tools_results_and_omits_unspecified_token_cap() {
        let body: Value = serde_json::from_slice(
            &build_request_body(&ProviderRequest {
                route: wrokbot_application::ProviderRoute::Managed,
                messages: vec![
                    wrokbot_application::ProviderMessage {
                    ...
                    wrokbot_application::ProviderMessage {
                        ...
                        tool_call_id: None,
                        tool_name: None,
                        tool_calls: vec![wrokbot_application::ProviderToolCall {
    ...
    async fn adapter_uses_header_not_query_key_and_streams_safe_http() {
        ...
        let mut session = adapter
            .start(ProviderRequest {
                route: wrokbot_application::ProviderRoute::Managed,
                messages: vec![wrokbot_application::ProviderMessage {
                    role: ProviderMessageRole::User,
                    content: "hello".to_owned(),
                    tool_call_id: None,
                    tool_name: None,
