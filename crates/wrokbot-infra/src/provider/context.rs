...
use wrokbot_domain::remote_callback::{RemoteRunAssertionSigner, RemoteRunScope, RemoteToolSet};
...
fn map_component_error(
    error: wrokbot_application::ComponentAdministrationError,
) -> AgentContextError {
    match error {
        wrokbot_application::ComponentAdministrationError::NotVisible => AgentContextError::Stale,
        wrokbot_application::ComponentAdministrationError::Corrupt { .. }
        | wrokbot_application::ComponentAdministrationError::InvalidInput { .. } => {
            AgentContextError::Corrupt {
                field: "component_catalogue",
            }
        }
        wrokbot_application::ComponentAdministrationError::Unavailable
        | wrokbot_application::ComponentAdministrationError::CommitUnknown
        | wrokbot_application::ComponentAdministrationError::Conflict => {
...
fn map_sandboxed_component_error(
    error: wrokbot_application::SandboxedComponentAdministrationError,
) -> AgentContextError {
    match error {
        wrokbot_application::SandboxedComponentAdministrationError::NotVisible => {
            AgentContextError::Stale
        }
        wrokbot_application::SandboxedComponentAdministrationError::Corrupt { .. }
        | wrokbot_application::SandboxedComponentAdministrationError::InvalidInput { .. } => {
            AgentContextError::Corrupt {
                field: "sandboxed_component_catalogue",
            }
        }
        wrokbot_application::SandboxedComponentAdministrationError::Unavailable
        | wrokbot_application::SandboxedComponentAdministrationError::CommitUnknown
        | wrokbot_application::SandboxedComponentAdministrationError::Conflict => {
            AgentContextError::Unavailable
        }
    }
}
