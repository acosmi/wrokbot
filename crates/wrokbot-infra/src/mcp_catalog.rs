...
use wrokbot_application::ProviderToolDefinition;
use wrokbot_contracts::ids::{ActorId, BotId, CatalogGeneration};
...
use wrokbot_domain::tool::metadata::{Effect, ToolName};
use wrokbot_domain::vault::{CredentialGeneration, SecretBytes};
