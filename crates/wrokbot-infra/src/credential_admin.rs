...
const ADMIN_METADATA: &str = "_wrokbot_credential_admin";
...
pub struct PostgresCredentialAdministration {
    ...
    model_reference: Option<wrokbot_contracts::credential_admin::CredentialModelReference>,
}
...
impl PostgresCredentialAdministration {
    ...
    pub fn with_model_reference(mut self, provider: String, key_id: String) -> Result<Self, Error> {
        ...
        self.model_reference = Some(
            wrokbot_contracts::credential_admin::CredentialModelReference { provider, key_id },
        );
        Ok(self)
    }
