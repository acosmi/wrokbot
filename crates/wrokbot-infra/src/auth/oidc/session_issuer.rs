...
use wrokbot_domain::identity::revocation::{DenyListAnswer, SignInPath, screen_sign_in};
use wrokbot_domain::identity::roles::{
...
pub(crate) struct FederatedIdentity {
    ...
    subject: String,
    email: String,
    groups: std::collections::BTreeSet<wrokbot_domain::identity::groups::GroupName>,
    group_normalization: wrokbot_domain::identity::groups::GroupNormalization,
}
