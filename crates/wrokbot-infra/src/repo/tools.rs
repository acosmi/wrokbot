...
use wrokbot_contracts::ids::{AttemptId, CapabilityId, PolicyDecisionId, ToolCallId};
use wrokbot_domain::audit::event::{AuditEvent, AuditEventType};
use wrokbot_domain::audit::payload::{AuditIdentifier, AuditLabel};
use wrokbot_domain::tool::commit::CommitState;
use wrokbot_domain::tool::pipeline::DurableDecisionReceipt;
...
async fn append_tool_audit(
    ...
    payload: wrokbot_domain::audit::payload::AuditPayload,
    checkpoint_key: &[u8],
) -> Result<(), InfraError> {
