...
use wrokbot_application::ToolExecutionCancellation;
...
impl SafeRmcpClient {
    ...
    async fn connect(
        ...
        let client_info = ClientInfo::new(
            ...
            Implementation::new("wrokbot-rs", env!("CARGO_PKG_VERSION")),
        );
