...
use wrokbot_contracts::components::ComponentDecision;
...
use wrokbot_domain::components::{ComponentGrantFacts, decide_component_grant};
...
impl SandboxedComponentAdministration for PostgresSandboxedComponentAdministration {
    ...
    async fn authorize_sandboxed_component(
        ...
        if let wrokbot_domain::components::ComponentGrantDecision::Refused(reason) =
