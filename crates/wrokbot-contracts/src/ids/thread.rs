...
mod tests {
    ...
    fn here() -> ThreadIdentity {
        ThreadIdentity::new(&DeploymentId::new("wrokbot-production"))
    }

    fn elsewhere() -> ThreadIdentity {
        ThreadIdentity::new(&DeploymentId::new("wrokbot-staging"))
    }
    ...
    fn it_is_a_well_formed_uuid_which_is_all_the_platform_accepts() {
        ...
        // 独立 shell oracle：printf wrokbot-production | shasum -a 256 => 380f214c3212…
        assert_eq!(
            here().mint_from_entropy([0; UUID_BYTES]).as_str(),
            "380f214c-3212-8000-8000-000000000000"
        );
    }
    ...
    fn the_same_name_recognises_threads_minted_by_another_process() {
        ...
        assert!(ThreadIdentity::new(&DeploymentId::new("wrokbot-production")).owns(&minted));
    }
