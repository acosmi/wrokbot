...
//!
//! Validates:
//! 1. Exact set equality between fixture event types and `wrokbot_agent::agui::AGUI_EVENT_TYPES` (33 events).
...
fn test_official_fixture_provenance_integrity() {
    ...
    assert_eq!(prov["schema"], "wrokbot-fixture-provenance-v1");
