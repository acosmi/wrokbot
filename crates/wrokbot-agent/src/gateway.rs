...
use wrokbot_contracts::sandboxed::{SANDBOXED_COMPONENT_CONFIRMATION, is_sandboxed_component_name};
use wrokbot_contracts::tool::{ToolInvocation, ToolResult};
    ...
    match result {
        Ok(result) => Ok(AgentToolReply {
            ...
            error_code: result.error_code.or_else(|| {
                (result.commit_state == wrokbot_contracts::tool::ToolCommitState::NotCommitted)
...
mod tests {
    ...
    use async_trait::async_trait;
    use wrokbot_application::{AgentAuthorizationError, AppEventStream, health};
    use wrokbot_contracts::auth::Role;
    use wrokbot_contracts::command::{HealthReport, SubscriptionRequest};
    use wrokbot_contracts::components::{
    ...
    use wrokbot_contracts::ids::{ActorId, DeploymentId, TenantId, ThreadId};
    use wrokbot_contracts::tool::{ToolCommitState, ToolResult};
    ...
    impl ApplicationService for ComponentApplication {
        ...
        async fn subscribe(
            ...
            Ok(wrokbot_application::use_cases::health_stream(
