...
use wrokbot_contracts::ids::{ComputerGeneration, ComputerId};
...
mod tests {
    ...
    const BROWSER_RUNTIME_BUDGET_FIXTURE_SHA256: &str =
        "e3a1ca0ebeebec2476c96471c63e09d069d954d2b01f78bba2f6a24d43fbca5b";
    ...
    fn browser_runtime_budget_fixture_is_closed_and_does_not_overclaim_assembly() {
        ...
        assert_eq!(fixture["schema"], "wrokbot-browser-runtime-budget-v1");
        assert_eq!(
