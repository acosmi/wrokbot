    ...
    view! {
        <PageShell>
            ...
            <PageSection heading_id="computers-inventory" title=move || t_string!(i18n, computer.inventory).to_owned()>
                ...
                <p class="wrokbot-page-intro">{move || t!(i18n, computer.manager_pending_body)}</p>
            </PageSection>
            <PageSection heading_id="computers-controls" title=move || t_string!(i18n, computer.control_boundary).to_owned()>
                <p class="wrokbot-page-intro">{move || t!(i18n, computer.control_boundary_body)}</p>
                <a class="wrokbot-plugin-link" href="/admin/boundaries">{move || t!(i18n, computer.configure_policy)}</a>
                <a class="wrokbot-plugin-link" href="/admin/audit">{move || t!(i18n, computer.review_audit)}</a>
            </PageSection>
        </PageShell>
    }
}
