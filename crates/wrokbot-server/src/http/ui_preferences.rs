...
mod tests {
    ...
    use wrokbot_application::{
        ChannelReader, WrokBotApplication, PortError, UiPreferenceAdministration,
    ...
    use wrokbot_contracts::ui::{UiLocale, UiTheme};
    ...
    fn router(preferences: FakePreferences) -> Router {
        ...
        let application = Arc::new(
            WrokBotApplication::new(EmptyChannels).with_ui_preferences(Arc::new(preferences)),
        );
    ...
    async fn preferences_are_typed_same_origin_and_mirrored_to_one_closed_cookie() {
        ...
        assert_eq!(
            ...
            "wrokbot-ui=v1.system.zh-CN; Path=/; Max-Age=31536000; SameSite=Lax; HttpOnly; Secure"
        );
        assert_eq!(
        ...
        let put = send(
            ...
            Method::PUT,
            Some("https://app.example.test"),
            Some("wrokbot-ui=v1.system.zh-CN"),
            None,
            r#"{"theme":"dark"}"#,
        )
        .await;
        ...
        assert_eq!(
            ...
            "wrokbot-ui=v1.dark.zh-CN; Path=/; Max-Age=31536000; SameSite=Lax; HttpOnly; Secure"
        );
        assert_eq!(
            serde_json::from_slice::<UiPreferences>(
        ...
        assert!(
            locale.headers()[SET_COOKIE]
                .to_str()
                .unwrap()
                .starts_with("wrokbot-ui=v1.dark.en;")
        );
        assert_eq!(
