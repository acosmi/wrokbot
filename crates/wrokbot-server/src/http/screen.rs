...
use wrokbot_contracts::command::{AppCommand, AppReply};
use wrokbot_contracts::error::AppError;
use wrokbot_contracts::screen::{
...
mod tests {
    ...
    use wrokbot_application::{
        ApplicationService, ChannelCursor, ChannelReader, WrokBotApplication, PortError,
    };
    use wrokbot_computer::screen::testing::attach_test_stream;
    use wrokbot_computer::screen::{SCREEN_VIEWER_PROTOCOL, ScreenHub, ScreenSessionService};
    ...
    use wrokbot_contracts::screen::{ScreenSessionTarget, ScreenSessionTicket};
    use wrokbot_domain::identity::session::{SessionState, TrustedOrigins, evaluate_session};
    ...
    struct BudgetTransport {
        hub: ScreenHub,
        target: ScreenSessionTarget,
        feed: wrokbot_computer::screen::testing::TestScreenFeed,
        router: Router,
        address: std::net::SocketAddr,
                ...
                loop {
                    match self
                        ...
                        .issue_ticket_for_target(
                            ...
                            &self.target.tab_id,
                            wrokbot_computer::screen::ScreenViewerBinding::verified_server(
                    ...
                    {
                        Ok(_) => break,
                        Err(wrokbot_computer::screen::ScreenHubError::ViewerLimit) => {
    ...
    fn fixture_locks_server_transport_and_remaining_production_boundary() {
        ...
        assert_eq!(fixture["schema"], "wrokbot-server-screen-websocket-v1");
