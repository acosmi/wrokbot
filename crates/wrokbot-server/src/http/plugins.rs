...
use wrokbot_application::{McpOAuthCallbackInput, McpOAuthCallbackOutcome};
    ...
    match state
        ...
        .execute(
            ...
            AppCommand::ListPluginsForAgent {
                agent_id: wrokbot_contracts::ids::BotId::new(agent_id),
            },
        )
        .await?
    {
...
mod tests {
    ...
    use wrokbot_application::{
        ...
        McpOAuthCallback, WrokBotApplication, PortError,
    };
    ...
    impl McpConnectionAdministration for FakeConnections {
        ...
        async fn list_for_agent(
            &self,
            auth: &AuthContext,
            agent_id: &wrokbot_contracts::ids::BotId,
