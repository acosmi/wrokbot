...
mod tests {
    ...
    use wrokbot_application::{
        ChannelReader, WrokBotApplication, PortError, SandboxedComponentAdministration,
    ...
    fn application(sandboxed: FakeSandboxed) -> Arc<dyn wrokbot_application::ApplicationService> {
        Arc::new(
