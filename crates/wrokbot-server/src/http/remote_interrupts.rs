...
mod tests {
    ...
    use wrokbot_application::{
        ChannelReader, WrokBotApplication, PortError, ProviderRemoteInterruptBatch,
    ...
    use wrokbot_contracts::remote_interrupt::RemoteInterruptAnswerStatus;
    ...
    fn router(interrupts: Arc<FakeInterrupts>) -> Router {
        ...
        let application =
            Arc::new(WrokBotApplication::new(EmptyChannels).with_remote_interrupts(interrupts));
