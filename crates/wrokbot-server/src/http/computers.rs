...
use wrokbot_contracts::policy::{ActionPolicyDocument, ActionPolicyMode, ActionPolicyResponse};
...
mod tests {
    ...
    use wrokbot_application::{
        ChannelCursor, ChannelReader, WrokBotApplication, PolicyAdministration,
    ...
    fn application(policies: FakePolicies) -> Arc<dyn wrokbot_application::ApplicationService> {
        Arc::new(WrokBotApplication::new(EmptyChannels).with_policy(policies))
    }
