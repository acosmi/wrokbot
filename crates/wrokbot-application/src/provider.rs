...
use wrokbot_contracts::remote_interrupt::is_remote_interrupt_request_id;
...
pub struct RunModelBinding {
    deployment: wrokbot_contracts::ids::DeploymentId,
    tenant: wrokbot_contracts::ids::TenantId,
    run_id: wrokbot_contracts::ids::RunId,
    thread_id: wrokbot_contracts::ids::ThreadId,
    bot_id: wrokbot_contracts::ids::BotId,
    actor: wrokbot_contracts::ids::ActorId,
    fencing: wrokbot_domain::thread::FencingToken,
    auth_generation: wrokbot_contracts::auth::AuthGeneration,
    connection_id: String,
    connection_revision: i64,
    secret_id: String,
    protocol: wrokbot_contracts::model_connections::CustomModelProtocol,
    endpoint: String,
    model: String,
}
...
impl RunModelBinding {
    ...
    pub fn from_verified_snapshot(
        ...
        tenant: wrokbot_contracts::ids::TenantId,
        auth_generation: wrokbot_contracts::auth::AuthGeneration,
        selection: wrokbot_contracts::model_connections::RunModelSelection,
        secret_id: String,
        ...
        let secret_shape = wrokbot_contracts::model_connections::RunModelSelection {
    ...
    pub fn deployment(&self) -> &wrokbot_contracts::ids::DeploymentId {
        &self.deployment
    }
    /// Fixed tenant identity.
    pub fn tenant(&self) -> &wrokbot_contracts::ids::TenantId {
        &self.tenant
    }
    ...
    pub fn actor(&self) -> &wrokbot_contracts::ids::ActorId {
        &self.actor
    }
    ...
    pub const fn protocol(&self) -> wrokbot_contracts::model_connections::CustomModelProtocol {
        self.protocol
    }
...
///
/// WrokBot does not ship mutable vendor list prices. The deployment owner records the rate that
...
pub struct ProviderRateCardInput {
    ...
    pub model: String,
    /// Three-letter uppercase currency code; WrokBot performs no conversion.
    pub currency: String,
...
/// Raw HTTP/SSE port. Semantic decoding remains in `wrokbot-agent`.
#[async_trait]
