...
use wrokbot_contracts::command::{ChannelDetail, ChannelPage, ChannelSummary, MAX_CHANNEL_PAGE};
...
/// `wrokbot_contracts::command`，两者合起来复现上游那一行钳制：
///
/// ```text
...
mod tests {
    ...
    fn detail_injects_full_scope_and_projects_only_detail_fields() {
        ...
        summary.agent_ids = vec![wrokbot_contracts::ids::BotId::new("bot-1")];
        summary.thread_id = Some(wrokbot_contracts::ids::ThreadId::new("thread-1"));
        ...
        assert_eq!(
            ...
            vec![(
                ChannelReadScope {
                    deployment: wrokbot_contracts::ids::DeploymentId::new("dep-g1"),
                    tenant: wrokbot_contracts::ids::TenantId::new("tenant-g1"),
                    actor: wrokbot_contracts::ids::ActorId::new("actor-a"),
                },
                ChannelId::new("channel-1"),
            )]
        );
    ...
    fn negative_limit_is_rejected_by_the_type_not_by_clamping() {
        use wrokbot_contracts::command::AppCommand;
        assert!(
    ...
    fn the_actor_passed_to_the_port_comes_from_the_auth_context() {
        ...
        assert_eq!(
            ...
            vec![ChannelReadScope {
                deployment: wrokbot_contracts::ids::DeploymentId::new("dep-g1"),
                tenant: wrokbot_contracts::ids::TenantId::new("tenant-g1"),
                actor: wrokbot_contracts::ids::ActorId::new("actor-authoritative"),
            }]
        );
    }
}
