...
use wrokbot_contracts::command::{AppCommand, AppEvent, AppReply, SubscriptionRequest};
use wrokbot_contracts::error::AppError;
...
/// 3. 契约文档已经这么写了：`wrokbot_contracts::command` 的模块注释原文是
...
/// `wrokbot_contracts::telemetry::METRICS_LABEL_ALLOWLIST` 里（附带过基数论证），要么
...
mod tests {
    ...
    use wrokbot_contracts::ids::{ActorId, BotId, RunId, ToolCallId};
    use wrokbot_contracts::telemetry::is_allowed_metrics_label;
    use wrokbot_contracts::tool::ToolInvocation;
    use serde_json::json;
        ...
        let commands = [
            ...
            (
                AppCommand::GetVisibleChannel {
                    channel_id: wrokbot_contracts::ids::ChannelId::new("channel-1"),
                },
                "get_visible_channel",
            ),
            (AppCommand::GetCurrentUser, "get_current_user"),
            ...
            (
                AppCommand::SetActionPolicy {
                    policy: wrokbot_contracts::policy::ActionPolicyDocument {
                        mode: wrokbot_contracts::policy::ActionPolicyMode::Enforce,
                        deny: Vec::new(),
            ...
            (
                AppCommand::GetThreadStatus {
                    thread_id: wrokbot_contracts::ids::ThreadId::new(
            ...
            (
                AppCommand::BeginThreadRun(wrokbot_contracts::command::BeginThreadRun {
                    ...
                    run_id: RunId::new("r2"),
                    bot_id: BotId::new("b2"),
                    anchor: wrokbot_contracts::command::ThreadRunAnchor::DirectBot,
            ...
            (
                AppCommand::RememberMemory(wrokbot_contracts::memory::RememberMemory {
                    memory_kind: wrokbot_contracts::memory::MemoryKind::Preference,
                    scope: wrokbot_contracts::memory::MemoryScope::User,
                    content: "tea".to_owned(),
                    tags: Vec::new(),
                    sensitivity: wrokbot_contracts::memory::MemorySensitivity::Normal,
                    source: None,
                    expires_at: None,
                }),
                "remember_memory",
            ...
            (
                AppCommand::CorrectMemory {
                    ...
                    correction: wrokbot_contracts::memory::CorrectMemory {
            ...
            (
                AppCommand::MutateMemory {
                    memory_id: "m".to_owned(),
                    mutation: wrokbot_contracts::memory::MemoryMutation::Delete,
                },
                "mutate_memory",
            ),
            (
                AppCommand::RecallMemories(wrokbot_contracts::memory::RecallMemories {
            ...
            (
                AppCommand::BeginMcpOAuth {
                    ...
                    return_to: wrokbot_contracts::mcp::McpOAuthReturnTo::Settings,
                },
                "begin_mcp_oauth",
            ),
            (
            ...
            (
                AppCommand::RegisterMcpOAuthClient {
                    server_id: "notes".to_owned(),
                    registration: wrokbot_contracts::mcp::McpOAuthClientRegistration::new(
                        "client".to_owned(),
                        "secret".to_owned(),
                        "https://issuer.example".to_owned(),
                        wrokbot_contracts::mcp::McpOAuthClientAuthMethod::ClientSecretBasic,
                        None,
                    )
                    .unwrap(),
                },
            ...
            (
                AppCommand::AddCustomMcpServer(
                    wrokbot_contracts::mcp::McpCustomServerRegistration {
                        id: "notes".to_owned(),
            ...
            (
                AppCommand::SavePluginSkill(wrokbot_contracts::mcp::PluginSkillMutation {
            ...
            (
                AppCommand::GrantPlugin(wrokbot_contracts::mcp::PluginGrantMutation {
                    kind: wrokbot_contracts::mcp::PluginGrantKind::Skill,
            ...
            (
                AppCommand::RevokePlugin(wrokbot_contracts::mcp::PluginGrantMutation {
                    kind: wrokbot_contracts::mcp::PluginGrantKind::Skill,
                    reference: "review-notes".to_owned(),
                    agent_id: "agent-one".to_owned(),
                }),
            ...
            (
                AppCommand::DecideToolApproval {
                    ...
                    decision: wrokbot_contracts::tool::ToolApprovalDecision::Grant,
                },
                "decide_tool_approval",
            ),
            (AppCommand::GetUiPreferences, "get_ui_preferences"),
            (
                AppCommand::UpdateUiPreferences(wrokbot_contracts::ui::UpdateUiPreferences {
                    theme: Some(wrokbot_contracts::ui::UiTheme::Dark),
                    locale: None,
                }),
            ...
            (
                AppCommand::ReplaceRunCostBudget(
                    wrokbot_contracts::budget::RunCostBudgetPreference::default(),
                ),
            ...
            (
                AppCommand::ResolveRemoteInterrupt {
                    ...
                    answer: wrokbot_contracts::remote_interrupt::RemoteInterruptAnswer {
                        status: wrokbot_contracts::remote_interrupt::RemoteInterruptAnswerStatus::Cancelled,
                        payload: None,
                    },
                },
