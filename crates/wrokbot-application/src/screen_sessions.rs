...
use wrokbot_contracts::screen::{ScreenSessionRequest, ScreenSessionTicket};
...
/// Screen ticket authority implemented by `wrokbot-computer` and shared by Server/Desktop.
#[async_trait]
