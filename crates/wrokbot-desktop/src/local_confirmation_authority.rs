...
use wrokbot_contracts::{auth::AuthContext, error::AppError};
...
pub(crate) struct PostgresLocalConfirmationAuthority {
    installation: wrokbot_infra::auth::single_user::desktop_local::DesktopLocalAuthority,
    ...
    async fn verify_current(&self, expected: &AuthContext) -> Result<AuthContext, AppError> {
        ...
        let current = self
            ...
            .map_err(|error| match error {
                wrokbot_infra::db::InfraError::RepositoryInvariant {
