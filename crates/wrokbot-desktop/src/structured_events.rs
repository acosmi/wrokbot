...
use wrokbot_contracts::command::SubscriptionRequest;
...
pub use wrokbot_contracts::desktop::{
        ...
        async fn subscribe(
            ...
            let event = match request {
                ...
                SubscriptionRequest::ToolApprovalActivity => AppEvent::ToolApprovalActivity(
                    wrokbot_contracts::tool::ToolApprovalActivityEvent { pending_count: 1 },
                ),
            };
        ...
        async fn subscribe(
            ...
            let events = (0..BURST_EVENTS_PER_STREAM)
                .map(|index| match &request {
                    ...
                    SubscriptionRequest::ToolApprovalActivity => AppEvent::ToolApprovalActivity(
                        wrokbot_contracts::tool::ToolApprovalActivityEvent {
