...
use wrokbot_application::tenant::package::LoadedTenantPackage;
use wrokbot_contracts::auth::AuthContext;
use wrokbot_domain::vault::secret::SecretBytes;
...
use wrokbot_infra::db::desktop_local::{
    DesktopLocalDatabase, DesktopLocalDatabaseError, DesktopLocalDatabaseOrigin,
    connect_for_attestation,
};
use wrokbot_infra::db::desktop_vault_canary::VerifiedDesktopVaultCanary;
                    ...
                    return Err(self
                        .cleanup_with(DesktopLocalCompositionError::Bootstrap(
                            DesktopLocalBootstrapError::Principal(
                                wrokbot_infra::db::InfraError::repository_invariant(
