...
use wrokbot_contracts::desktop::local_confirmation::{
...
fn protocol(application: Arc<ApplicationProbe>) -> Arc<DesktopTauriProtocol> {
    let files = BTreeMap::from([
        ("index.html".to_owned(), b"<!doctype html><html lang=\"en\"><head><script type=\"module\" src=\"/wrokbot-bootstrap.mjs\"></script></head><body></body></html>".to_vec()),
