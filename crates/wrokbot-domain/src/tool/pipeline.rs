...
use wrokbot_contracts::ids::{ActorId, BotId, PolicyDecisionId, RunId, ToolCallId};
pub use wrokbot_contracts::ids::{AttemptId, CapabilityId};
...
pub struct ToolOutcome {
    ...
    /// 稳定错误码（`&'static str`，与 `wrokbot_contracts::error::ErrorCode` 同域）。
...
/// ```compile_fail,E0599
/// # use core::time::Duration;
/// # use wrokbot_contracts::ids::{RunId, ToolCallId};
...
mod tests {
    ...
    use wrokbot_contracts::ids::{ComputerGeneration, DocumentGeneration};
    use serde_json::json;
