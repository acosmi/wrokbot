...
use wrokbot_domain::backup::{CompatibilitySet, ComponentRev, ProofStatus};
use wrokbot_domain::upgrade_preflight::{
...
fn startup(epoch: u32, protocol: u32) -> StartupFacts {
    StartupFacts {
        ...
        compatibility_range: wrokbot_domain::upgrade_preflight::CompatibilityRange::Inclusive {
            min_core: 8,
            max_core: 12,
        },
    }
...
) -> Result<wrokbot_domain::upgrade_preflight::PreflightPlan, PreflightFault> {
...
fn assert_unauthorized(plan: &wrokbot_domain::upgrade_preflight::PreflightPlan) {
...
fn empty_too_long_duplicate_unbounded_unknown_and_overflow_do_not_succeed() {
    ...
    unbounded.startup.compatibility_range =
        wrokbot_domain::upgrade_preflight::CompatibilityRange::Unbounded;
    assert_eq!(
    ...
    unknown.startup.compatibility_range =
        wrokbot_domain::upgrade_preflight::CompatibilityRange::Unknown;
    assert_eq!(
