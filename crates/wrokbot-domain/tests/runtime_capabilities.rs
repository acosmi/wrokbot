...
use wrokbot_domain::identity::generation::GenerationMismatch;
use wrokbot_domain::runtime_capabilities::{
...
fn facts_all_ready() -> RuntimeCapabilityFacts {
    RuntimeCapabilityFacts {
        ...
        custom_model: wrokbot_domain::runtime_capabilities::ModelSourceFacts {
            key: ModelKeyFact::Present,
            provider: ProviderFact::Available,
        },
        sdk_model: wrokbot_domain::runtime_capabilities::ModelSourceFacts {
            key: ModelKeyFact::Present,
            provider: ProviderFact::Available,
        },
        bridge_model: wrokbot_domain::runtime_capabilities::ModelSourceFacts {
            key: ModelKeyFact::Present,
            provider: ProviderFact::Available,
        },
