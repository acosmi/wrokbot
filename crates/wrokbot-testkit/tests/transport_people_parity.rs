...
use wrokbot_application::{
    ApplicationService, ChannelCursor, ChannelReader, WrokBotApplication, PeopleAdministration,
...
impl Fixture {
    fn new() -> Self {
        ...
        let service: Arc<dyn ApplicationService> =
            Arc::new(WrokBotApplication::new(EmptyChannels).with_people(people.clone()));
