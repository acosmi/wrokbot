...
const ENGINE_CONSTANTS_RELPATH: &str = "crates/wrokbot-contracts/src/engine.rs";
const ENGINE_DESCRIPTOR_RELPATH: &str = "crates/wrokbot-contracts/engine-protocol-v4.json";
const ENGINE_BUNDLE_RELPATH: &str = "crates/wrokbot-testkit/src/xtask/engine_bundle.rs";
#[cfg(test)]
    ...
    impl TempTree {
        fn new(tag: &str) -> Self {
            ...
            let root = std::env::temp_dir().join(format!(
                "wrokbot-first-source-{tag}-{}-{nanos}",
                std::process::id()
            ));
